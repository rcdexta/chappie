...
module.exports = {
  ...
  wfh: ["Long commutes make you fat, stressed, and miserable! You chose wisely! %s!",
    ...
    "Well I hope you don't mean this! ;) http://bit.ly/2n41XLG"],
  ...
  office: ["Great %s! High speed wifi and low carb sundal awaits you!",
    ...
    "Nice %s :) I am planning to order a new office chair for you: https://xkcd.com/1329/",
    "You chose wisely!",
    "Please start early %s else see you for lunch! Come safe..."],
